...
const getBookById = (bookId) => __awaiter(void 0, void 0, void 0, function* () {
    const book = yield book_model_1.Book.findById(bookId).populate('author');
    return book;
});
const getBooks = (filters, paginationOptions) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    for (const prop of book_constant_1.bookFilterableFields) {
        if (!filtersData[prop]) {
...
const updateBook = (bookId, payload) => __awaiter(void 0, void 0, void 0, function* () {
    const updatedBook = yield book_model_1.Book.findByIdAndUpdate(bookId, payload, {
        new: true,
    });
    return updatedBook;
});
const addReview = (bookId, review) => __awaiter(void 0, void 0, void 0, function* () {
    var _a;
    const bookExist = yield book_model_1.Book.findById(bookId);
    if (!bookExist) {
        throw new ApiError_1.default(http_status_1.default.NOT_FOUND, 'Book not found');
    }
    (_a = bookExist.reviews) === null || _a === void 0 ? void 0 : _a.push(review);
    const updatedBook = yield bookExist.save();
    return updatedBook;
});
